...
export async function PATCH(request: NextRequest, { params }: RouteParams) {
  try {
    ...
    const apiUrl = `${API_BASE_URL}/api/v1/restaurants/${restaurantId}/stations/${stationId}/restore`;
    
    console.log('🔄 Frontend API: Restoring station via backend:', apiUrl);
    ...
    console.log('✅ Frontend API: Station restored successfully');
    ...
    return NextResponse.json(
      { 
        error: 'RESTORE_ERROR', 
        message: 'Failed to restore station via backend API',
